defmodule Search1.ItemsTest do
  ...
  describe "items" do
    ...
    @valid_attrs %{is_drug: true, name: "some name"}
    @update_attrs %{is_drug: false, name: "some updated name"}
    @invalid_attrs %{is_drug: nil, name: nil}
